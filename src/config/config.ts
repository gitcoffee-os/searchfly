 ...
 */
// export const BASE_URL = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://searchfly.exmay.com';
export const BASE_URL = 'https://searchfly.exmay.com';
export const BASE_API = `${BASE_URL}/exmay/authority/api`;
export const APP_ID = 'searchfly';
...
export const APP_INFO = {
  ...
  logoUrl: logoUrl,
  version: 'v1.0.0',
  officialWebsite: 'https://searchfly.exmay.com/',
